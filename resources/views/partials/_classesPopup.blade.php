                    ...
                    <div class="col-xl-6 col-lg-5 offset-1 col-6">
                        <div class="row">
                            <div class="col-6 form-group" style="padding-left: 0;">
                                <select style="height: 2.5em;" id="classType{{ $class }}" name="classType{{ $class }}" class="custom-select">
                            ...
                            <div class="col-6 form-group" style="padding-left: 0;">
                                <select style="height: 2.5em;" id="classLength{{ $class }}" name="classLength{{ $class }}" class="custom-select">
